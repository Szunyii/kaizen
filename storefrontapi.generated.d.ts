...
export type FooterQuery = {
  ...
  blogs: {nodes: Array<Pick<StorefrontAPI.Blog, 'id' | 'handle' | 'title'>>};
  articles: {
    nodes: Array<
...
export type HomeImageFragment = Pick<
  StorefrontAPI.Image,
  'id' | 'altText' | 'url' | 'width' | 'height'
>;

export type HomeVariantFragment = Pick<
  StorefrontAPI.ProductVariant,
...
export type ContactPoliciesQueryVariables = StorefrontAPI.Exact<{
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
}>;

export type ContactPoliciesQuery = {
  shop: {
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query ContactPolicies($language: LanguageCode, $country: CountryCode)\n  @inContext(language: $language, country: $country) {\n    shop {\n      privacyPolicy { handle }\n    }\n  }\n': {
    return: ContactPoliciesQuery;
    variables: ContactPoliciesQueryVariables;
  };
